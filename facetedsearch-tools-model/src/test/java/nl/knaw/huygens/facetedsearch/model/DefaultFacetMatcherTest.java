...
public class DefaultFacetMatcherTest {
  ...
  public void testMatchesSafely() {
    ...
    DefaultFacetMatcher matcher = new DefaultFacetMatcher(facetName, facetTitle, options);
  ...
  public void testMatchesSafelyDifferentName() {
    ...
    List<FacetOption> options = Lists.newArrayList(option1, option2);
    String facetTitle = "title";
    DefaultFacetMatcher matcher = new DefaultFacetMatcher("expectedName", facetTitle, options);
  ...
  public void testMatchesSafelyDifferentTitle() {
    ...
    List<FacetOption> options = Lists.newArrayList(option1, option2);
    String facetName = "name";
    DefaultFacetMatcher matcher = new DefaultFacetMatcher(facetName, "exepectedTitle", options);
  ...
  public void testMatchesSafelyDifferentOptions() {
    ...
    String facetTitle = "title";
    String facetName = "name";
    DefaultFacetMatcher matcher = new DefaultFacetMatcher(facetName, facetTitle, expectedOptions);
